...
from tools.board import *           # returns XY cordnates for board
...
# delay input untill animation complete
...
gameControler = 0   # 0:Board 1:Animate 2:Card
...
White = (255, 255, 255)
Gray = (125, 125, 125)
textFont = pygame.font.SysFont(None, 50)    #preset default font
...
while running:
    ...
    for event in pygame.event.get():
            ...
            # input logic
            elif (event.type == pygame.KEYDOWN) and (gameControler==0):
                ...
                if event.key == pygame.K_w:  # take turn
                    gameControler = 1  # set to animation
                    turn = turn + 1
    ...
    if gameControler==1:         # animation
        ...
        if done:
            ...
            for obj in Players:
                if obj.pos==Players[ActivePlayer].pos and obj!=Players[ActivePlayer] and Players[ActivePlayer].pos!=0:
                    obj.pos = 0
                    obj.Apos = 0
                    print("Goomba Stomp")           # Make this a image later
            gameControler = 0   # switch to game board if animation is done
    ...
    text_line1 = textFont.render(line1, True, (Black))
    text_line2 = textFont.render(line2, True, (Black))
    text_line3 = textFont.render(line3, True, (Black))
    ...
    if card:    # Display card if 'card' is true
        ...
        cardTitle = textFont.render(cardTitle, True, (Black))  # color and font
        ...
        if len(gameDeck[cardDraw].choicesText)==0:
            ...
            text_buttonLine = textFont.render(buttonLine, True, (White))  # color and font
